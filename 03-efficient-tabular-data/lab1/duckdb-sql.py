...
# TODO 1:
# Copy the Silver prefix that Step 1 printed after writing Parquet.
# Use only the key prefix, not s3:// and not the bucket name.
SILVER_PREFIX = "TODO_FILL_SILVER_PREFIX"
...
def main() -> None:
    ...
    # TODO 2:
    # Read the SQL query below and replace TODO_FILL_SQL_ROW_COUNT_EXPRESSION.
    # Hint: in SQL, count(*) counts all rows in the current group.
    summary_sql = f"""
    select
        {group_column},
        TODO_FILL_SQL_ROW_COUNT_EXPRESSION,
