...
def main() -> None:
    ...
    # TODO:
    # Replace TODO_FILL_ROW_COUNT_EXPRESSION with the SQL expression that counts
    # rows per payment type. Hint: count every row and name the result "rows".
    payment_sql = f"""
        SELECT
            payment_type,
            TODO_FILL_ROW_COUNT_EXPRESSION,
        ...
        ORDER BY rows DESC
        """
    require_completed(payment_sql, "TODO: complete the payment_type SQL query.")
    payment_type_rows = connection.execute(payment_sql).fetchdf()
